...
public class Compiler implements ICompiler {
    private final static UETLogger logger = UETLogger.get(Compiler.class);
    ...
    public String generateCompileCommand(String filePath) {
        ...
        List<String> userCodes = new ArrayList<>();// EnvironmentUserCode.getInstance().getAllFilePath();
