package entities.compiler.message.error_tree;

import entities.SpecialCharacter;
import entities.compiler.AvailableCompiler;
import entities.compiler.Compiler;
import entities.compiler.message.ICompileMessage;
import entities.compiler.message.error_tree.node.*;
...
import entities.search.condition.SourcecodeFileNodeCondition;
import entities.utils.PathUtils;
...
//                .searchNodes(Environment.getInstance().getProjectNode(), new SourcecodeFileNodeCondition());
        ...
        List<INode> sourceFiles = Search
                .searchNodes(null, new SourcecodeFileNodeCondition());
