...
import entities.cfg.*;
import entities.instrument.FunctionInstrumentationForStatementvsBranch_Marker;
 ...
 *
 * The algorithm is quite complex, however, in reality we do not need this algorithm.
 *
 * @author ducanhnguyen
 */
@Deprecated
public class CFGUpdater_Mark implements ICFGUpdater {
	final static UETLogger logger = UETLogger.get(CFGUpdater_Mark.class);
