...
import entities.cfg.*;
import entities.instrument.FunctionInstrumentationForStatementvsBranch_Markerv2;
...
import entities.testpath.FullTestpath;
import entities.testpath.ITestpathInCFG;
import entities.testpath.StatementInTestpath_Mark;
...
public class CFGUpdaterv2 implements ICFGUpdater {
    final static UETLogger logger = UETLogger.get(CFGUpdaterv2.class);
