...
public class MacroNormalizer2 extends AbstractFunctionNormalizer implements IFunctionNormalizer {
	...
	final static UETLogger logger = UETLogger.get(MacroNormalizer2.class);
...
//		AbstractAutomatedTestdataGeneration.macroNormalizationTime += end.getTime() - startTime.getTime();
	}
