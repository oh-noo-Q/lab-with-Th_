...
//        norm.normalize();
            ...
            public int visit(IASTExpression statement) {
                ...
                if (statement instanceof CPPASTFunctionCallExpression
                    ...
                    try {
						 ...
						 */
                        StructOrClassNode classKind = SetterandGetterFunctionNormalizer.this
     ...
     * @return
     */
    private StructOrClassNode findStructureGetterKind(IASTExpression statement) {
        /*
          find classNode of variable having getter | setter
         */

        StructOrClassNode classKind = findStructureKind((IASTExpression) statement.getChildren()[0]);
     ...
     * @return
     */
    private StructOrClassNode findStructureKind(IASTExpression statement) {
    ...
    private void megaTranform() {
        ...
        for (int i = 0; i < mappingVariables.size(); i++) {
            ...
            String aftStr = oldFunction.substring(tempAdjustment + variableToMap.getOffset()
                    + variableToMap.getOldVariable().length() - functionOffset);
    ...
    class MappingVariable {
        ...
        public boolean isEqual(String oldVariable) {
            return this.oldVariable.equals(oldVariable);
        }

        public boolean isEqual(String oldVariable, int level) {
            return this.oldVariable.equals(oldVariable) && this.level == level;
        }
