...
import entities.parser.dependency.FunctionCallDependencyGeneration;
import entities.parser.dependency.GlobalVariableDependencyGeneration;
...
public class FunctionNodeParser {
    ...
    final static UETLogger logger = UETLogger.get(FunctionNodeParser.class);
