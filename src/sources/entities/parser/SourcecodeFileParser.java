...
import entities.normalizer.Cpp11ClassNormalizer;
...
public class SourcecodeFileParser implements ISourcecodeFileParser {
    final static UETLogger logger = UETLogger.get(SourcecodeFileParser.class);
...
//        String path = "/Users/ducanhnguyen/Documents/akautauto/datatest/fsoft/c-algorithms/src/list.h";
        String path = "/home/lamnt/IdeaProjects/akautauto/datatest/official_tested_projects/app-framework-binder/src/afb-hsrv.c";
                        ...
                        if (template instanceof IASTFunctionDefinition) {
                            ...
                            if (declSpec instanceof IASTCompositeTypeSpecifier) {
                                ...
                                // template variable case
                                    ...
                                    VariableNode var = addVariableNode(simpleDeclaration, stackNodes, declarationNode);
                                    if (var != null) {
                                        declarationNode = var;
...
//                                var.setPrivate(isPrivate);
//                            }
                        VariableNode var = addVariableNode((IASTSimpleDeclaration) declaration, stackNodes, declarationNode);
                        if (var != null) {
                            declarationNode = var;
                            var.setPrivate(isPrivate);
                        }
...
//        createSpecialNode(root);
    ...
    private VariableNode addVariableNode(IASTSimpleDeclaration decList, CustomCppStack stackNodes,
                                 INode declarationNode) {
        for (IASTDeclarator dec : decList.getDeclarators()) {
