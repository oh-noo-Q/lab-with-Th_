...
import entities.search.condition.HeaderNodeCondition;
import entities.search.condition.IncludeHeaderNodeCondition;
...
public class IncludeHeaderDependencyGeneration extends AbstractDependencyGeneration{
    final static UETLogger logger = UETLogger.get(IncludeHeaderDependencyGeneration.class);
