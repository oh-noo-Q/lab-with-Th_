...
import entities.search.condition.StructurevsTypedefCondition;
    ...
    public INode find(String simpleFunctionName, IASTInitializerClause[] params) {
        ...
        for (Level l : spaces)
            for (INode n : l) {
                ...
                SystemLibraryRoot libraryRoot =null;// Environment.getInstance().getSystemLibraryRoot();
                if (libraryRoot != null) {
                ...
                INode dataUserCodeRoot = null;// Environment.getInstance().getUserCodeRoot();
