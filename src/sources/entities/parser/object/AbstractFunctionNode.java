...
import entities.common.INameRule;
import entities.normalizer.*;
import entities.cfg.ICFG;
import entities.parser.externalvariable.ReducedExternalVariableDetecter;
...
public abstract class AbstractFunctionNode extends CustomASTNode<IASTFunctionDefinition> implements IFunctionNode {
	final static UETLogger logger = UETLogger.get(AbstractFunctionNode.class);
