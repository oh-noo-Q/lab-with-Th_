...
import entities.compiler.ICompiler;
...
public class CompilerUtils {
    final static UETLogger logger = UETLogger.get(CompilerUtils.class);
...
//        }
    ...
    public static ICompileMessage testCompile(String returnType, String prototype, ICommonFunctionNode functionNode, INode context) {
        ...
        ICompileMessage message =null;// Environment.getInstance().getCompiler().compile(temporaryPath);
