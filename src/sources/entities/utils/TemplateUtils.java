...
import entities.resolver.NewTypeResolver;
...
import entities.search.condition.DefinitionFunctionNodeCondition;
...
public class TemplateUtils {
    final static UETLogger logger = UETLogger.get(TemplateUtils.class);
...
//                    if (typeName.equals(rawType)){
    ...
    public static String getTemplateFullRawType(VariableNode variableNode) {
        ...
        List<INode> functions = null;// Search.searchNodes(Environment.getInstance().getProjectNode(), conditions);
...
//    }
    ...
    public static String getTemplateFullName(VariableNode variable) {
        ...
        List<INode> functions = null;// Search.searchNodes(Environment.getInstance().getProjectNode(), new FunctionNodeCondition(), functionPath);

        if (functions.isEmpty())
            functions = null;// Search.searchNodes(Environment.getInstance().getProjectNode(), new DefinitionFunctionNodeCondition(), functionPath);
